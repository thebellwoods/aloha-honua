...
HelloPlaydate = {
	isRunning = false,
	images = "challenges/1-hello/assets/images/", -- relative path seems to be difficult so that you create the path from the source 
	fonts = "challenges/1-hello/assets/fonts/",
	audio = "challenges/1-hello/assets/audio/",
	A = playdate.kButtonA,
	B = playdate.kButtonB,
