...
function GameGrid:startRestartTimer()
...
-- cancelRestartTimer()
--
function GameGrid:cancelRestartTimer()
...
--
function GameGrid:setBackgroundDrawingCallback()
...
-- addStartTiles()
--
function GameGrid:addStartTiles()
...
--
function GameGrid:addStartTilesFromSave()
...
-- hasAvailableMoves()
--
function GameGrid:hasAvailableMoves()
...
function GameGrid:drawButton()
	...
	playdate.graphics.setImageDrawMode(playdate.graphics.kDrawModeFillWhite)
		...
		playdate.graphics.drawText(string.upper("New GameGrid"), 32, 240 - (gGridBorderSize / 2) - defaultFont:getHeight() + 2)
...
-- drawGameOverScreen()
--
function GameGrid:drawGameOverScreen()
...
-- saveBestScore()
--
function GameGrid:saveBestScore()
...
function GameGrid:initInputHandlers()
...
function GameGrid:moveUp() 		self.grid:move(1) end
function GameGrid:moveRight() 	self.grid:move(2) end
function GameGrid:moveDown() 	self.grid:move(3) end
function GameGrid:moveLeft()	self.grid:move(4) end