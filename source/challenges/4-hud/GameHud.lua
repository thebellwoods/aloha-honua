...
import "challenges/3-grid/Cursor"
import "challenges/3-grid/Grid"

import "challenges/4-hud/Hud"
...
function GameHud:startRestartTimer()
...
-- cancelRestartTimer()
--
function GameHud:cancelRestartTimer()
...
--
function GameHud:setBackgroundDrawingCallback()
...
-- addStartTiles()
--
function GameHud:addStartTiles()
...
--
function GameHud:addStartTilesFromSave()
...
-- hasAvailableMoves()
--
function GameHud:hasAvailableMoves()
...
function GameHud:drawButton()
	...
	playdate.graphics.setImageDrawMode(playdate.graphics.kDrawModeFillWhite)
		...
		playdate.graphics.drawText(string.upper("New GameHud"), 32, 240 - (gGridBorderSize / 2) - defaultFont:getHeight() + 2)
...
-- drawGameOverScreen()
--
function GameHud:drawGameOverScreen()
...
-- saveBestScore()
--
function GameHud:saveBestScore()
...
function GameHud:initInputHandlers()
...
function GameHud:moveUp() 		self.grid:move(1) end
function GameHud:moveRight() 	self.grid:move(2) end
function GameHud:moveDown() 	self.grid:move(3) end
function GameHud:moveLeft()	self.grid:move(4) end
--]]