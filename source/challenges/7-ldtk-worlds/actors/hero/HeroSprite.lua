...
import "challenges/7-ldtk-worlds/libraries/AnimatedSprite"
import "challenges/7-ldtk-worlds/actors/hero/HeroModel"

class('HeroSprite').extends(AnimatedSprite)

function HeroSprite:init(x, y, gameManager)
  self.gameManager = gameManager
  print (x, y)

  -- State Machine
  local playerImageTable = gfx.imagetable.new("challenges/7-ldtk-worlds/assets/images/player")
  ...
  -- draw the sprite with playAnimation but it won't animate until we set the state
  self:playAnimation()
...
function HeroSprite:updateJumpBuffer()
  self.jumpBuffer -= 1
...
function HeroSprite:playerJumped()
...
function HeroSprite:handleAirInput()
...
function HeroSprite:changeToJumpState()
  self.yVelocity = self.jumpVelocity
  self.jumpBuffer = 0
  self:changeState("jump")
end

function HeroSprite:changeToFallState()
  self:changeState("jump")
end

function HeroSprite:changeToDashState()
...
function HeroSprite:applyGravity()
...
function HeroSprite:applyDrag(amount)
  if self.xVelocity > 0 then
